...
export default function Contact() {
  ...
  const handleSubmit = e => {
    ...
    if (!SERVICE_ID || !TEMPLATE_ID || !PUBLIC_KEY) {
      console.error('EmailJS config missing. Please set VITE_EMAILJS_SERVICE_ID, VITE_EMAILJS_TEMPLATE_ID and VITE_EMAILJS_PUBLIC_KEY in .env');
      setStatus({ submitted: false, submitting: false, info: { error: true, msg: 'Envoi impossible : configuration Email non trouvée.' } });
      return;
    }

    if (!emailjs || typeof emailjs.send !== 'function') {
      console.error('emailjs package is not available. Install @emailjs/browser and restart dev server.');
    ...
    // Utiliser emailjs.send pour un payload JSON explicite
  ...
  // initialise EmailJS si la clé publique est exposée
  useEffect(() => {
    try {
      ...
      // noop: si emailjs non disponible côté SSR ou clé absente
      ...
      <section className="liquid-glass contact-container">
        ...
        <div className="contact-content">
          ...
          <div className="contact-methods" style={{ marginTop: '1.5rem' }}>
            ...
            <a 
            href="mailto:allancontactdevpro@gmail.com" 
            style={{
              display: 'flex',
              alignItems: 'center',
              gap: '0.8rem',
          ...
          <a 
            href="https://www.linkedin.com/in/allanlannoy/" 
            target="_blank" 
          ...
          <a 
            href="https://github.com/AllanLny" 
            target="_blank" 
            rel="noopener noreferrer"
            style={{
              display: 'flex',
          ...
          >
            ...
            <div className="response-note" style={{ marginTop: '1.25rem' }}>
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" style={{ opacity: 0.85 }}>
                <path d="M12 0c-6.627 0-12 5.373-12 12 0 6.627 5.373 12 12 12s12-5.373 12-12c0-6.627-5.373-12-12-12zm1 17h-2v-2h2v2zm0-4h-2v-7h2v7z"/>
              </svg>
